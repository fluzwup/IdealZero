	function RunBallistics()
	{
		...
		outputDoc.innerHTML += "Laser boresight at " + Math.round(10 * sightHt / radians / 36) / 10 + " yds, or ";
		outputDoc.innerHTML += Math.round(100 * (sightHt - radians * 5 * 36)) / 100 + " in low at 5 yards\n";
